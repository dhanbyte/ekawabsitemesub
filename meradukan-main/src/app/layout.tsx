...
export const metadata: Metadata = {
  title: 'ShopWave - Online Shopping Site | Best Prices | Free Delivery | Best Deals',
  description: 'ShopWave - Online Shopping Site! Best prices guaranteed, free delivery, best deals on tech, home & ayurvedic products. Shop now and save more!',
